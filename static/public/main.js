  ...
  var roll = function (v) {
      return function (v1) {
          return function (v2) {
              ...
              if (v2) {
                  var strat = Data_Maybe_Unsafe.fromJust(Data_Array.index(v)(v1));
                  return Prelude.show(Strat.showStrat)(strat);
              };
              throw new Error("Failed pattern match at Main line 49, column 1 - line 50, column 1: " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
  var handler = function (strats) {
      return function (b) {
          return function __do() {
              ...
              return Flare.runFlareShow(Prelude.showString)("null")("output")(Prelude.pure(Flare.applicativeUI)(roll(strats)(v)(b)))();
          };
      };
  };
