...
(function(exports) {
  ...
  var showMap = new Prelude.Show(function (v) {
      return "(Map { name: " + (Prelude.show(Prelude.showString)(v.value0.name) + (", " + ("sixes: " + (Prelude.show(Prelude.showBoolean)(v.value0.sixes) + (", " + ("hl: " + (Prelude.show(Prelude.showBoolean)(v.value0.hl) + (", " + ("mm: " + (Prelude.show(Prelude.showBoolean)(v.value0.mm) + " })"))))))))));
  });
  var mapIsForeign = new Data_Foreign_Class.IsForeign(function (value) {
      return Prelude.bind(Data_Either.bindEither)(Data_Foreign_Class.readProp(Data_Foreign_Class.stringIsForeign)(Data_Foreign_Index.indexString)("name")(value))(function (v) {
          return Prelude.bind(Data_Either.bindEither)(Control_Bind[">=>"](Data_Either.bindEither)(Data_Foreign_Index.prop("available"))(Data_Foreign_Class.readProp(Data_Foreign_Class.booleanIsForeign)(Data_Foreign_Index.indexString)("sixes"))(value))(function (v1) {
              return Prelude.bind(Data_Either.bindEither)(Control_Bind[">=>"](Data_Either.bindEither)(Data_Foreign_Index.prop("available"))(Data_Foreign_Class.readProp(Data_Foreign_Class.booleanIsForeign)(Data_Foreign_Index.indexString)("hl"))(value))(function (v2) {
                  return Prelude.bind(Data_Either.bindEither)(Control_Bind[">=>"](Data_Either.bindEither)(Data_Foreign_Index.prop("available"))(Data_Foreign_Class.readProp(Data_Foreign_Class.booleanIsForeign)(Data_Foreign_Index.indexString)("mm"))(value))(function (v3) {
                      return Prelude.pure(Data_Either.applicativeEither)(new $$Map({
                          name: v, 
                          sixes: v1, 
                          hl: v2, 
                          mm: v3
  ...
  var main = (function () {
      var stratsFromRes = function (res) {
          return Data_Either_Unsafe.fromRight(Data_Foreign_Class.readJSON(Data_Foreign_Class.arrayIsForeign(stratIsForeign))(res));
      };
      return Control_Monad_Aff.launchAff(Prelude.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableString)("./api/strats"))(function (v) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Random.randomInt(0)(6)))(function (v1) {
              return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log(Prelude.show(Data_Maybe.showMaybe(showStrat))(Data_Array.index(stratsFromRes(v.response))(v1))));
          });
      }));
  })();
  exports["Strat"] = Strat;
  ...
  exports["mapIsForeign"] = mapIsForeign;
