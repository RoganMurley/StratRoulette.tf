...
(function(exports) {
  ...
  var Strat = PS["Strat"];
  var Network_HTTP_Affjax_Response = PS["Network.HTTP.Affjax.Response"];        
  var getValue = function ($$new) {
      return function (v) {
          return $$new;
      };
  };
  var counter = function (n) {
      var s = Prelude.show(Prelude.showInt)(n);
      return Flare.foldp(getValue)(s)(Flare.button("Roll")("")(s));
  };
  var handler = function (n) {
      return function __do() {
          var v = Control_Monad_Eff_Random.randomInt(0)(6)();
          return Flare.runFlareShow(Prelude.showString)("controls_b")("output")(counter(v))();
      };
  };
  var $$interface = function (strats) {
      return Flare.runFlareWith("controls_a")(handler)(Flare.intRange("numPoints")(1)(100)(10));
  };
  var main = (function () {
