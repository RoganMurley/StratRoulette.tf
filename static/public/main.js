...
var _user$project$Util$fromJust = function (m) {
	...
	if (_p0.ctor === 'Just') {
		...
		return _elm_lang$core$Native_Utils.crashCase(
			...
			_p0)('Used fromJust on Nothing.');
	}
};

var _user$project$Strats$strats = _user$project$Util$fromJust(
	_mgold$elm_nonempty_list$List_Nonempty$fromList(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				tags: _elm_lang$core$Native_List.fromArray(
					['any_map', 'engineer', 'medic', 'loadout'])
			},
				{
				name: 'Steak and Bake',
				...
				tags: _elm_lang$core$Native_List.fromArray(
					['any_map', 'demoman', 'soldier', 'loadout'])
			},
				{
				name: 'Critical Mass',
				desc: 'Everyone Scout using Backscatter, Crit-a-Cola and Fan-o-War.',
...
var _user$project$Strats$slug = function (_p0) {
	var _p1 = _p0;
	var validChar = function (x) {
		return A2(
			_elm_lang$core$List$member,
			x,
			_elm_lang$core$String$toList('abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ '));
	};
	return A2(
		_elm_lang$core$String$join,
		'_',
...
var _user$project$Main$Active = function (a) {
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Strat Roulette')
								])),
							A2(
							_elm_lang$html$Html$div,
							_elm_lang$core$Native_List.fromArray(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('TF2 Strategy Generator')
								]))
						])),
					A2(
					_elm_lang$html$Html$div,
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$html$Html_Attributes$class('roll-button')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Reroll')
								]))
						]))
				]));
	}
