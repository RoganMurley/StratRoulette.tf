  ...
  var roll = function (v) {
      return function (v1) {
          return function (v2) {
              ...
              if (v2) {
                  var strat = Data_Array.index(v)(v1);
                  return Prelude.show(Data_Maybe.showMaybe(Strat.showStrat))(strat);
              };
              throw new Error("Failed pattern match at Main line 48, column 1 - line 49, column 1: " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
  var handler = function (strats) {
      return function (b) {
          return function __do() {
              ...
              return Flare.runFlareShow(Prelude.showString)("controls_b")("output")(Prelude.pure(Flare.applicativeUI)(roll(strats)(v)(b)))();
          };
      };
  };
  var $$interface = function (strats) {
      return Flare.runFlareWith("controls")(handler(strats))(Flare.button("Roll")(true)(false));
  };
  var main = (function () {
      ...
      return Control_Monad_Aff.launchAff(Prelude.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableString)("./api/strats"))(function (v) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Prelude.pure(Control_Monad_Aff.applicativeAff)(stratsFromRes(v.response)))(function (v1) {
              return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)($$interface(v1));
          });
      }));
  })();
  exports["roll"] = roll;
